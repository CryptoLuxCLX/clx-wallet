...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "CryptoLux - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "CryptoLux Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the CryptoLux debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the CryptoLux-Qt help message to get a list with possible CryptoLux command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
