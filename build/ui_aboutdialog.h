...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CryptoLux", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>CryptoLux</b> version", Q_NULLPTR));
...
"Copyright \302\251 2018 The CryptoLux developers", Q_NULLPTR));
