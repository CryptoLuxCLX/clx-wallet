...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CLX"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CLX"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CLX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CLX"));
